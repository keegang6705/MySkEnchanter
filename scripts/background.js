...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
    if (changeInfo.status == "complete" && (tab.url === "https://www.mysk.school/classes" || tab.url === "https://www.mysk.school/en-US/classes")) {
    ...
    } else if (changeInfo.status == "complete" && (tab.url.startsWith("https://www.mysk.school/classes?ske=true") || tab.url.startsWith("https://www.mysk.school/en-US/classes?ske=true"))) {
