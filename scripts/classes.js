        ...
        studentLi.addEventListener("click", function () {
          ...
          studentLi.appendChild(skcCardHeader);
            ...
            skcCardHeader.appendChild(skcCardHeaderContent)
              ...
              if (document.documentElement.lang == "th"){
                skcCardHeaderSubTitle.textContent= "เลขที่ " + classroom_students[i].class_no + " • " + classroom_students[i].students.people.nickname_th
              }else{
                skcCardHeaderSubTitle.textContent= "No. " + classroom_students[i].class_no + " • " + classroom_students[i].students.people.nickname_en
              };
